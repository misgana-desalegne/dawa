...
const baseExpressionsByLevel = {
  A1: [
    ...
    { id: "a1_please", en: "Please", fr: "S'il vous plaît", am: "እባክህ", ti: "በጃኻ", fa: "لطفا" },
    ...
    { id: "a1_where_is", en: "Where is...?", fr: "Où est...?", am: "... የት ነው?", ti: "... ኣበይ ኣሎ?", fa: "... کجاست؟" },
    ...
    { id: "a1_very_well", en: "Very well, thank you", fr: "Très bien, merci", am: "በጣም ጥሩ ነው፣ እናመሰግናለን", ti: "ብዙሕ ጥሩ እዩ፣ የቐንየለይ", fa: "خیلی خوب، ممنون" },
    ...
    { id: "a1_where_do_you_live", en: "Where do you live?", fr: "Où habitez-vous?", am: "የት ትኖራለህ?", ti: "ኣበይ ትነብር?", fa: "کجا زندگی می کنید؟" },
    ...
    { id: "a1_slower_please", en: "Slower, please", fr: "Plus lentement, s'il vous plaît", am: "እባክዎ በዝቶ", ti: "በጃኹም ብዝሒ", fa: "آهسته تر لطفا" },
    { id: "a1_i_dont_understand", en: "I don't understand", fr: "Je ne comprends pas", am: "አልገባኝም", ti: "ኣይተረድኣንን", fa: "متوجه نمی شوم" },
    { id: "a1_what_does_it_mean", en: "What does it mean?", fr: "Qu'est-ce que ça veut dire?", am: "ምን ማለት ነው?", ti: "መን እዩ ማለት?", fa: "چه معنایی دارد؟" },
    ...
    { id: "a1_where_is_the_bathroom", en: "Where is the bathroom?", fr: "Où sont les toilettes?", am: "የመፀዳጃ ቦታ የት ነው?", ti: "ኣበይ ኣሎ መፀዳጃ ቦታ?", fa: "دستشویی کجاست؟" },
    ...
    { id: "a1_bus_stop", en: "Where is the bus stop?", fr: "Où est l'arrêt de bus?", am: "የአውቶቡስ ማቆሚያ የት ነው?", ti: "ኣበይ ኣሎ መዓቀፊ ኣውቶቡስ?", fa: "ایستگاه اتوبوس کجاست؟" },
    { id: "a1_train_station", en: "Where is the train station?", fr: "Où est la gare?", am: "የባቡር ጣቢያ የት ነው?", ti: "ኣበይ ኣሎ ጣብያ ባቡር?", fa: "ایستگاه قطار کجاست؟" },
    { id: "a1_how_do_i_get_to", en: "How do I get to...?", fr: "Comment aller a...?", am: "... እንዴት እችላለሁ መሄድ?", ti: "... ከመይ እኸይድ?", fa: "چطور بروم به...؟" },
    { id: "a1_left_right", en: "Left or right?", fr: "À gauche ou à droite?", am: "ግራ ወይም ቀኝ?", ti: "ጸጋማ ወይ የማን?", fa: "چپ یا راست؟" },
    ...
    { id: "a1_near_far", en: "Is it near or far?", fr: "C'est près ou loin?", am: "አጭር ወይም ራቅ ነው?", ti: "ቅሩብ ወይ ራሓቅ እዩ?", fa: "نزدیک است یا دور؟" },
    { id: "a1_walking_distance", en: "Is it walking distance?", fr: "Est-ce à distance de marche?", am: "በእግር መሄድ የሚሆን ርቀት ነው?", ti: "ብእግር ክምለስ የብሎም ራሓቅ እዩ?", fa: "فاصله پیاده روی است؟" },
    { id: "a1_taxi_please", en: "Taxi, please", fr: "Taxi, s'il vous plaît", am: "ታክሲ እባክዎ", ti: "ታክሲ በጃኹም", fa: "تاکسی لطفا" },
    { id: "a1_how_much_to", en: "How much to...?", fr: "Combien pour aller a...?", am: "... እንዴት ነው ዋጋው?", ti: "... ክንደይ እዩ ዋጋ?", fa: "تا ... چقدر است؟" },
    { id: "a1_one_ticket", en: "One ticket, please", fr: "Un billet, s'il vous plaît", am: "አንድ ትኬት እባክዎ", ti: "ኣሐዱ ትኬት በጃኹም", fa: "یک بلیط لطفا" },
    ...
    { id: "a1_where_are_you_from", en: "Where are you from?", fr: "D'où venez-vous?", am: "ከየት ነህ የምትመጣ?", ti: "ካበይ ትመጽእ?", fa: "از کجا هستید؟" },
  ...
  A2: [
    ...
    { id: "a2_hospital", en: "Hospital", fr: "Hôpital", am: "ሆስፒታል", ti: "ሆስፒታል", fa: "شفاخانه" },
    { id: "a2_market", en: "Market", fr: "Marché", am: "ገበያ", ti: "ዕዳጋ", fa: "بازار" },
    ...
    { id: "a2_tired", en: "I am tired", fr: "Je suis fatigué", am: "ደክሞኛል", ti: "ደኪመ", fa: "من خسته هستم" },
  ...
  B1: [
    ...
    { id: "b1_skills", en: "I want to improve my skills", fr: "Je veux améliorer mes compétences", am: "ክህሎቴን ማሻሻል እፈልጋለሁ", ti: "ክእለተይ ከምዕብል እደሊ", fa: "می خواهم مهارت هایم را بهتر کنم" },
  ...
  B2: [
    ...
    { id: "b2_digital", en: "Digital services", fr: "Services numériques", am: "ዲጂታል አገልግሎቶች", ti: "ዲጂታል ኣገልግሎታት", fa: "خدمات دیجیتال" },
...
const supplementConfigs = {
  ...
  A2: {
    ...
    objects: [
      { en: "the market", fr: "le marché", de: "den Markt", am: "ገበያ", ti: "ዕዳጋ", fa: "بازار" },
